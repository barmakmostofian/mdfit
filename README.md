...
MDFitML is a framework for small-molecule potentcy prediction based on protein-ligand simulation fingerprints (SimFPs). It is based on the [MDFit](dx.doi.org/10.1007/s10822-024-00564-2) workflow but significantly augmented in terms of end-to-end automation and results interpretation. 
